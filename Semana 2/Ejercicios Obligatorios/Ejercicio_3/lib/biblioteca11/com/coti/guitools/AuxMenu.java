...
public class AuxMenu {
    ...
    /**
     * 
     * @param nameOfMenu the name of the menu
     * @param listOfJMenuItems the names of the menu options
    ...
    /**
     * 
     * @param listOfJMenus a list of JMenus to be used when building the menu bar
