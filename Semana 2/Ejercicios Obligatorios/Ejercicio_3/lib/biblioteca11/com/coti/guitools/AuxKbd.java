...
public class AuxKbd {
   ...
   *
	...
	*
         */
        String temp;
        ArrayList<String> line_vector = new ArrayList<>();
    ...
    /**
     * **************************************************************************
     * The following methods are overloaded.There are three versions for each of
     * them: one that takes no parameters, one that takes a String that will be
     * used as a prompt, and one that takes both a String and two numbers that
     * will be used as inclusive lower and upper limits. In this way, we can
     * impose a measure of validity on the numbers we read. The next methods
     * process integer numbers.
     * **************************************************************************
     * @return This method returns an int; it will ask repeatedly for an int
     * until given a valid value
     */
