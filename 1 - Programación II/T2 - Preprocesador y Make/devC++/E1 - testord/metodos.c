...
/*--------------------------------------------------------------*/
/* Ordenamos por el m�todo de la burbuja una vector de enteros. */
/*--------------------------------------------------------------*/
{
  int  cambio;
  long pasadas, k;
  ...
  fin=clock();
  return ( (fin-ini)/CLOCKS_PER_SEC) ;
}


long ordena_insercion (long dim, int *la)
/*--------------------------------------------------------------*/
/* Ordenamos por el m�todo de inserci�n un vector de enteros.   */
/*--------------------------------------------------------------*/
{
   int  encontrado;
...
/*--------------------------------------------------------------*/
/* Ordenamos por el m�todo de selecci�n un vector de enteros.   */
/*--------------------------------------------------------------*/
{
   long mayor, k, j;
   int  temp;  /* Mismo tipo que el de los elementos del vector */
